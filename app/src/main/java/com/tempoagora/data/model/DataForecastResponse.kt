...
internal data class DataForecastResponse(
    ...
    @SerializedName("moonrise_ts") val moonriseTs: Int,
    @SerializedName("moonset_ts") val moonsetTs: Int,
    ...
    @SerializedName("sunrise_ts") val sunriseTs: Int,
    @SerializedName("sunset_ts") val sunsetTs: Int,
    @SerializedName("temp") val temp: Double,
    @SerializedName("ts") val ts: Int,
    @SerializedName("uv") val uv: Double,
    @SerializedName("valid_date") val validDate: String,
    @SerializedName("vis") val vis: Double,
    @SerializedName("weather") val weather: WeatherLocalForecastResponse,
    ...
    @SerializedName("wind_gust_spd") val windGustSpd: Double,
